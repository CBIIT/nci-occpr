					...
					<section class="row <?php print $alt_header_classes; ?>">
						...
						<div class="large-4 columns left-head-block">
							...
							<div id="site-name" class="element-invisible">
								<center><strong><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"><span><?php print $site_name; ?></span></a></strong>
								</center>
							</div>
							<?php else: /* Use h1 when the content title is empty */ ?>
							<h1 id="site-name">
								<center><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"><span><?php print $site_name; ?></span></a>
								</center>
							</h1>
							<?php endif; ?>
							<?php endif; ?>
